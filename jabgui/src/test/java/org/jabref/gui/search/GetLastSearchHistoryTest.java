...
class GetLastSearchHistoryTest {
    ...
    private final BibDatabaseContext dbContext1 = BibDatabaseContext.builder().build();
    private final BibDatabaseContext dbContext2 = BibDatabaseContext.builder().build();
